...
<x-admin.master>
    ...
    <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
        ...
        <div class="d-flex flex-column flex-column-fluid">
            <!--begin::Toolbar-->
            <x-elements.toolbar lable="ادارة اعلانات البنر الفرعي" back_url="admin.sub-banners.index" previews="قائمة اعلانات البنر الفرعي"
                                current="إضافة اعلان البنر الفرعي" />
            <!--end::Toolbar-->
            <!--begin::Content-->
            <div id="kt_app_content" class="app-content flex-column-fluid">
                ...
                <div id="kt_app_content_container" class="app-container container-xxl">
                    {{-- <x-error-show-list /> --}}
                    <form class="form d-flex flex-column flex-lg-row" action="{{ route('admin.sub-banners.store') }}"
                            ...
                            <div class="card card-flush py-4 ">
                                ...
                                <div class="card-header border-0 ">
                                    <h3 class="card-title align-items-start flex-column">
                                        <span class="card-label fw-bold fs-3 mb-1"> إضافة إعلان للبنر الفرعي</span>
                                    </h3>
                                </div>
                                <!--end::Header-->
                                <!--begin::Body-->
                                ...
                                <div class="card-footer py-3">
                                    ...
                                    @endif
                                    <a href="{{ route('admin.sub-banners.index') }}"
