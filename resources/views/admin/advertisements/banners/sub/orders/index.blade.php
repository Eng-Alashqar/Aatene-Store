<x-admin.master>
    ...
    <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
        ...
        <div class="d-flex flex-column flex-column-fluid">
            <!--begin::Toolbar-->
            <x-elements.toolbar back_url="admin.home" previews="الرئيسية" current="قائمة طلبات اعلانات البنر الفرعي "/>
            <!--end::Toolbar-->
            <!--begin::Content-->
                                    ...
                                    @foreach ($sub_banner_ads as $sub_banner_ad)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('admin.sub-banner.accept', $sub_banner_ad->id) }}"
