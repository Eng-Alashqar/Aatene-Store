<x-admin.master>
    ...
    <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
        ...
        <div class="d-flex flex-column flex-column-fluid">
            <!--begin::Toolbar-->
            <x-elements.toolbar back_url="admin.home" previews="الرئيسية" current="قائمة طلبات اعلانات البنر الرئيسي"/>
            <!--end::Toolbar-->
            <!--begin::Content-->
                                    ...
                                    @foreach ($main_banner_ads as $main_banner_ad)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('admin.main-banner.accept', $main_banner_ad->id) }}"
