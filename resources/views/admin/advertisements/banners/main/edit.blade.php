        ...
        <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="kt_app_content" class="app-content flex-column-fluid">
                ...
                <div id="kt_app_content_container" class="app-container container-xxl">
                    {{-- <x-error-show-list /> --}}
                    <form class="form d-flex flex-column flex-lg-row" action="{{ route('admin.main-banners.update',$main_banner_ads->id) }}"
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <select name="store_id" dir="rtl" data-control="select2"
                                            ...
                                            @foreach ($stores as $store)
                                                <option value="{{ $store->id }}" @selected($main_banner_ads->store_id == $store->id)>{{ $store->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
