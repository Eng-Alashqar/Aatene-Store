                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-header border-0 pt-5">
                            ...
                            <div class="card-toolbar">
                                <a href="{{ route('admin.create.noti') }}" class="btn btn-sm btn-light-primary fs-3">
...
{{--                                                             class="lozad rounded mw-100" alt="" />--}}
                                            ...
                                            <td class="text-end">
                                                @if(!is_null($not->deleted_at))
                                                    ...
                                                    <form method="post" action="{{route('admin.restore.noti' , ['id' => $not->id])}}" class="d-inline">
                                                        @csrf
                                                ...
                                                <form method="post" action="{{route('admin.delete.noti',  ['id' => $not->id])}}" class="d-inline">
                                                    @csrf
                                                    <button
