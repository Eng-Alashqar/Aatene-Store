<x-admin.master>
    ...
    <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
        ...
        <div class="d-flex flex-column flex-column-fluid">
            <!--begin::Toolbar-->
            <x-elements.toolbar back_url="admin.home" previews="الرئيسية" current="قائمة المناطق" />
            <!--end::Toolbar-->
            <!--begin::Content-->
                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-header border-0 pt-5">
                            ...
                            <div class="card-toolbar">
                                <a href="{{ route('admin.regions.create') }}" class="btn btn-sm btn-light-primary fs-3">
                                    <i class="ki-duotone ki-plus "></i>اضافة منطقة </a>
                            </div>
                                ...
                                <table class="table align-middle gs-0 gy-4">
                                    ...
                                    <thead>
                                        <tr class="fw-bold text-muted bg-light fs-5">
                                            ...
                                            <th class="min-w-225px">المنطقة</th>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($regions as $region)
                                            <tr>
                                                ...
                                                <td>
                                                    <span
                                                        class="fs-5 fw-bold">{{ $region->created_at->format('Y/m/d') }}</span>
                                                </td>
                                                <td class="text-end">
                                                    ...
                                                    <a onclick="confirmDestroy({{ $region->id }}, this)"
    ...
    @push('scripts')
        ...
        <x-elements.delete-script name="regions" />
    @endpush
</x-admin.master>
