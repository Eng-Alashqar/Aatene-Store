    ...
    <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
        ...
        <div class="d-flex flex-column flex-column-fluid">
            ...
            <x-elements.toolbar  back_url="admin.faqs.index" previews="قائمة الأسئلة المكررة"
                current="إضافة سؤال مكرر" />
            <!--end::Toolbar-->
            <!--begin::Content-->
            <div id="kt_app_content" class="app-content flex-column-fluid">
                <!--begin::Content container-->
                <div id="kt_app_content_container" class="app-container container-xxl">
                      <form class="form d-flex flex-column flex-lg-row" action="{{ route('admin.faqs.store') }}" method="POST" >
                        @csrf
                        <!--begin::Main column-->
                            ...
                            <div class="card card-flush py-4 ">
                                ...
                                <div class="card-header border-0 ">
                                    <h3 class="card-title align-items-start flex-column">
                                        <span class="card-label fw-bold fs-3 mb-1"> إضافة سؤال مكرر</span>
                                    </h3>
                                </div>
                                <!--end::Header-->
                                <!--begin::Body-->
                                <div class="card-body py-3">
                                    ...
                                    <div class="mb-5">
                                        <x-form.textarea-with-lable lable="اجابة السؤال" name="answer"
                                            placeholder="ادخل الاجابة للسؤال" />
                                    </div>
                                </div>
                                <!--begin::Body-->
                                <!--begin::Footer-->
