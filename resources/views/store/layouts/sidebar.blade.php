            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                ...
                <div class="menu-item pt-5">
                    ...
                    <div class="menu-content">
                        <span class="menu-heading fw-bold text-uppercase fs-6">ادارة محتوى المتجر</span>
                    </div>
                    <!--end:Menu content-->
                </div>
                <!--end:Menu item-->
                ...
                <!--begin:Menu item-->
                <x-elements.sidebar-menu-item lable="ادارة المنتجات" index="dashboard.products.index"
                    ...
                    <x-elements.sidebar-li-sub-menu route="dashboard.products.index" title="قائمة المنتجات" />
                    <x-elements.sidebar-li-sub-menu route="dashboard.products.create" title="إضافة منتج" />
                ...
                <div class="menu-item pt-5">
                    <!--begin:Menu content-->
                    <div class="menu-content">
                        <span class="menu-heading fw-bold text-uppercase fs-6">الاعدادات</span>
                    </div>
                    <!--end:Menu content-->
                </div>
                <!--end:Menu item-->
        ...
        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5"
            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                ...
                <div class="menu-item pt-5">
                    <!--begin:Menu content-->
                    <div class="menu-content">
                        <span class="menu-heading fw-bold text-uppercase fs-3"> نظام الوظائف والإعلانات</span>
                    </div>
                    <!--end:Menu content-->
                </div>
                <!--end:Menu item-->
