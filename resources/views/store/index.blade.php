<x-store.master>
    ...
    <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
        ...
        <div class="d-flex flex-column flex-column-fluid">
            <x-elements.toolbar back_url="dashboard.home" previews="الرئيسية" current="الإحصائيات"/>
            <!--begin::Content-->
                                    ...
                                    <div class="card overflow-hidden h-md-50 mb-5 mb-xl-10">
                                        ...
                                        <div class="card-body d-flex justify-content-between flex-column px-0 pb-0">
                                            ...
                                            <div class="mb-4 px-9">
                                                ...
                                                <!--begin::Description-->
                                                <span
                                                    class="fs-6 fw-semibold text-gray-400">Total Online Visitors</span>
                                                <!--end::Description-->
                                            </div>
                                            <!--end::Statistics-->
                                            <!--begin::Chart-->
                                    ...
                                    <div class="card card-flush h-md-50 mb-xl-10">
                                        ...
                                        <div class="card-header pt-5">
                                            ...
                                            <div class="card-title d-flex flex-column">
                                                ...
                                                <!--begin::Subtitle-->
                                                <span
                                                    class="text-gray-400 pt-1 fw-semibold fs-6">Total New Customers</span>
                                                <!--end::Subtitle-->
                                            </div>
                                            <!--end::Title-->
                                        </div>
                            ...
                            <div class="card card-flush h-xl-100">
                                ...
                                <div class="card-header pt-7 mb-5">
                                    ...
                                    <h3 class="card-title align-items-start flex-column">
                                        ...
                                        <span
                                            class="text-gray-400 mt-1 fw-semibold fs-6">20 countries share 97% visits</span>
                                    </h3>
                                    <!--end::Title-->
                                    <!--begin::Toolbar-->
                                    <div class="card-toolbar">
                            ...
                            <div class="card card-flush h-xl-100">
                                ...
                                <div class="card-header pt-7">
                                    ...
                                    <h3 class="card-title align-items-start flex-column">
                                        ...
                                        <span
                                            class="text-gray-400 pt-2 fw-semibold fs-6">Performance & achievements</span>
                                    </h3>
                                    <!--end::Title-->
                                    <!--begin::Toolbar-->
                                    <div class="card-toolbar">
