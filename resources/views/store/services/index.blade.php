<x-store.master>
    ...
    <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
        ...
        <div class="d-flex flex-column flex-column-fluid">
            <!--begin::Toolbar-->
            <x-elements.toolbar back_url="dashboard.home" previews="الرئيسية" current="قائمة الخدمات" />
            <!--end::Toolbar-->
            <!--begin::Content-->
                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold fs-3 mb-1">قائمة الخدمات</span>
                                <span class="text-muted mt-1 fw-semibold fs-7">اكثر من {{ $services->total() }}
                                    خدمة</span>
                            </h3>
                            <div class="card-toolbar">
                                <a href="{{ route('dashboard.services.create') }}"
                                    class="btn btn-sm btn-light-primary fs-3">
                                    <i class="ki-duotone ki-plus "></i>اضافة خدمة </a>
                            </div>
                        </div>
                        <!--end::Header-->
                        <!--begin::Body-->
                                ...
                                <table class="table align-middle gs-0 gy-4">
                                    ...
                                    <thead>
                                        <tr class="fw-bold text-muted bg-light fs-5">
                                            ...
                                            <th class="min-w-200px">الخدمة</th>
                                            <th class="min-w-150px">التصنيف</th>
                                            <th class="min-w-70px">المدة</th>
                                    ...
                                    <tbody>
                                        @forelse ($services as $service)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="d-flex justify-content-start flex-column">
                                                            <a href="#"
                                                                class="text-dark fw-bold text-hover-primary mb-1 fs-6">{{ $service->name }}
                                                            </a>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <span
                                                        class="badge @if ($service->active === 1) badge-light-success
                                                            @else badge-light-danger @endif fs-7 fw-bold">
                                                        @if ($service->active === 1) مفعلة @else معطلة @endif
                                                    </span>
                                                </td>
                                                <td class="text-end">
                                                    ...
                                                    <a onclick="confirmDestroy({{ $service->id }}, this)"
                                        ...
                                        @empty
                                            <td colspan="7" class="text-primary fw-bold text-center mb-1 fs-6">
                                                لا يوجد خدمات، انقر على اضافة خدمة لاضافة خدمة جديدة
                                            </td>
                                        @endforelse
                                        <tr>
    ...
    @push('scripts')
        ...
        <x-elements.delete-script name="services" />
    @endpush
    </x-admin.master>
