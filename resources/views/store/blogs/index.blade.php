                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold fs-3 mb-1">المدونات</span>
                                <span class="text-muted mt-1 fw-semibold fs-7">اكثر من {{ $blogs->total() }}
                                    مدونة</span>
                            </h3>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span
                                                        ...
                                                        >@if($blog->is_published === 'new') تم النشر
                                                        @else مؤرشف @endif
                                                    </span>
                                                </td>
                                                <td class="text-end">
