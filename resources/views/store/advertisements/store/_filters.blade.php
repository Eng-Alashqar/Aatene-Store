    ...
    <div class="card-toolbar d-flex align-items-center">
        ...
        <div class="d-flex my-0">
            ...
            <select name="status" data-control="select2" data-hide-search="true"
                ...
                <option value="Active" @selected(request()->query('status') == 'Active')>اعلان فعال</option>
                <option value="Inactive" @selected(request()->query('status') == 'InActive')>إعلان غير فعال</option>
            </select>
            <!--end::Select-->
            <!--begin::Select-->
            <select name="count" data-control="select2" data-hide-search="true" data-placeholder="العدد" class="form-select form-select-sm border-body bg-body w-150px me-5">
