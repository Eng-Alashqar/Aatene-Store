<x-store.master>
    ...
    <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
        ...
        <div class="d-flex flex-column flex-column-fluid">
            <!--begin::Toolbar-->
            <x-elements.toolbar lable="ادارة اعلانات المنتجات" back_url="dashboard.product-advertisements.index" previews="اعلانات قائمة المنتجات"
                                current="تعديل اعلان لقائمة المنتجات" />
            <!--end::Toolbar-->
            <!--begin::Content-->
            <div id="kt_app_content" class="app-content flex-column-fluid">
                ...
                <div id="kt_app_content_container" class="app-container container-xxl">
                    {{-- <x-error-show-list /> --}}
                    <form class="form d-flex flex-column flex-lg-row" action="{{ route('dashboard.products-list.update',$products_list_ads->id) }}"
                            ...
                            <div class="card card-flush py-4 ">
                                ...
                                <div class="card-header border-0 ">
                                    <h3 class="card-title align-items-start flex-column">
                                        <span class="card-label fw-bold fs-3 mb-1"> تعديل إعلان لقائمة منتجات</span>
                                    </h3>
                                </div>
                                <!--end::Header-->
                                <!--begin::Body-->
                                <div class="row card-body py-3">
                                    ...
                                    <div class="mb-5">
                                        <x-form.input-with-lable lable="تاريخ بدء الاعلان" type="date" value="{{$products_list_ads->start_at}}"  name="start_at" id="start_datepicker" />
                                    </div>
                                    <div class="mb-5">
                                        <x-form.input-with-lable lable="تاريخ انتهاء الاعلان" type="date" value="{{$products_list_ads->end_at}}" name="end_at" id="end_datepicker" />
                                    </div>


                                        <div class="col-md-6 d-flex flex-column mb-8 fv-row">
                                            <x-form.input-with-lable readonly lable="سعر الاعلان لليوم/شيكل" value="{{$products_list_ads->price}}" name="price" id="price"  />
                                        </div>
                                        <div class="col-md-6 d-flex flex-column mb-8 fv-row">
                                            <x-form.input-with-lable readonly lable="سعر الإعلان الإجمالي/شيكل" id="total_price" value="{{$products_list_ads->total}}"  name="" />
                                        </div>
                                ...
                                <div class="card-footer py-3">
                                    ...
                                    <a href="{{ route('dashboard.products-list.index') }}"
