<x-store.master>
    ...
    <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
        ...
        <div class="d-flex flex-column flex-column-fluid">
            <!--begin::Toolbar-->
            <x-elements.toolbar back_url="dashboard.home" previews="الرئيسية" current=" اعلانات  قائمة المنتجات"/>
            <!--end::Toolbar-->
            <!--begin::Content-->
                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-header border-0 pt-5">
                            ...
                            <div class="card-toolbar">
                                <a href="{{ route('dashboard.products-list.create') }}"
                                   class="btn btn-sm btn-light-primary fs-3">
                                    <i class="ki-duotone ki-plus "></i>اضافة اعلان لقائمة منتجات </a>
                            </div>
                                ...
                                <table class="table align-middle gs-0 gy-4">
                                    ...
                                    @foreach ($products_list_ads as $products_list_ad)
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <a href="{{ route('admin.products-list.edit',$products_list_ad->id) }}"
