<x-store.master>
    ...
    <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
        ...
        <div class="d-flex flex-column flex-column-fluid">
            <!--begin::Toolbar-->
            <x-elements.toolbar back_url="dashboard.home" previews="الرئيسية" current="اعلانات المنتجات"/>
            <!--end::Toolbar-->
            <!--begin::Content-->
...
{{--                                @include('admin.advertisements.store._filters')--}}
                            ...
                            <div class="card-toolbar">
                                <a href="{{ route('dashboard.product-advertisements.create') }}"
...
{{--                                                             data-src="{{ $product_ad->product->image }}"--}}
                                            ...
                                            <td>
                                                <span class="badge badge-light-primary fs-7 fw-bold"> {{ $product_ad->end_at }}</span>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-end">
                                                <a href="{{ route('dashboard.product-advertisements.edit',$product_ad->id) }}"
