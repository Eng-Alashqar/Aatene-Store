...
<x-store.master>
    ...
    <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
        ...
        <div class="d-flex flex-column flex-column-fluid">
            <!--begin::Toolbar-->
            <x-elements.toolbar lable="ادارة اعلانات البنر الرئيسي" back_url="dashboard.main-banners.index" previews="قائمة اعلانات البنر الرئيسي"
                                current="تعديل اعلان البنر الرئيسي" />
            <!--end::Toolbar-->
            <!--begin::Content-->
            <div id="kt_app_content" class="app-content flex-column-fluid">
                ...
                <div id="kt_app_content_container" class="app-container container-xxl">
                    {{-- <x-error-show-list /> --}}
                    <form class="form d-flex flex-column flex-lg-row" action="{{ route('dashboard.main-banners.update',$main_banner_ads->id) }}"
                            ...
                            <div class="card card-flush py-4 ">
                                ...
                                <div class="card-header border-0 ">
                                    <h3 class="card-title align-items-start flex-column">
                                        <span class="card-label fw-bold fs-3 mb-1"> تعديل إعلان للبنر الرئيسي</span>
                                    </h3>
                                </div>
                                <!--end::Header-->
                                <!--begin::Body-->
                                <div class="row card-body py-3">
                                    <div class="mb-5">
                                        <x-form.input-with-lable lable="المتجر" disabled  value="{{auth()->user()->store->name}}"   />
                                    ...
                                    <div  class="col-md-6 ">
                                        ...
                                        <output id="result">
                                            @foreach(json_decode($main_banner_ads->image) as $key => $image)
                                    ...
                                    <div class="mb-5">
                                        <x-form.input-with-lable lable="تاريخ بدء الاعلان" type="date" value="{{$main_banner_ads->start_at}}"  name="start_at" id="start_datepicker" />
                                    </div>
                                    <div class="mb-5">
                                        <x-form.input-with-lable lable="تاريخ انتهاء الاعلان" type="date" value="{{$main_banner_ads->end_at}}" name="end_at" id="end_datepicker" />
                                    </div>

                                        <div class="col-md-6 d-flex flex-column mb-8 fv-row">
                                            <x-form.input-with-lable readonly lable="سعر الاعلان لليوم/شيكل" value="{{$main_banner_ads->price}}" name="price" id="price"  />
                                        </div>

                                        <div class="col-md-6 d-flex flex-column mb-8 fv-row">
                                            <x-form.input-with-lable readonly lable="سعر الإعلان الإجمالي/شيكل" value="{{$main_banner_ads->total}}" id="total_price"  name="" />
                                        </div>
                                ...
                                <div class="card-footer py-3">
                                    ...
                                    <a href="{{ route('dashboard.main-banners.index') }}"
