        ...
        <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="kt_app_content" class="app-content flex-column-fluid">
                ...
                <div id="kt_app_content_container" class="app-container container-xxl">
                    {{-- <x-error-show-list /> --}}
                    <form class="form d-flex flex-column flex-lg-row" action="{{ route('dashboard.main-banners.store') }}"
                        ...
                        <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                            <div class="card card-flush py-4 ">
                                ...
                                <div class="row card-body py-3">
                                    <div class="mb-5">
                                        <x-form.input-with-lable lable="المتجر" disabled  name="" value="{{auth()->user()->store->name}}"  />
                                        <x-form.input-with-lable  type="hidden"  name="store_id"  value="{{auth()->user()->store_id}}" />
                                    </div>
