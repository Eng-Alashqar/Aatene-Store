<x-store.master>
    ...
    <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
        ...
        <div class="d-flex flex-column flex-column-fluid">
            <!--begin::Toolbar-->
            <x-elements.toolbar back_url="dashboard.home" previews="الرئيسية" current="قائمة اعلانات البنر الفرعي"/>
            <!--end::Toolbar-->
            <!--begin::Content-->
                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-header border-0 pt-5">
                            ...
                            <div class="card-toolbar">
                                <a href="{{ route('dashboard.sub-banners.create') }}"
                                ...
                                <table class="table align-middle gs-0 gy-4">
                                    ...
                                    @foreach ($sub_banner_ads as $sub_banner_ad)
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <a href="{{ route('dashboard.sub-banners.edit',$sub_banner_ad->id) }}"
    ...
    @push('scripts')
        ...
        <x-elements.delete-script name="sub-banners" dashboard="dashboard"/>
    @endpush
</x-store.master>
