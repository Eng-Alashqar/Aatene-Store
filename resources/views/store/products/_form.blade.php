        ...
        <div class="card card-flush py-4">
            ...
            <div class="card-body pt-0">
                ...
                <div class="mb-5">
                    ...
                    <select name="category_id" dir="rtl" class="form-select @error('category_id')
                    is-invalid
                    ...
                    <div class="card card-flush py-4 ">
                        ...
                        <div class="card-body py-3">
                           ...
                           <div class="mb-5">
                               ...
                               <!--end::Label-->
                               <!--begin::Input-->
                               <input id="tags" name="tags" class="form-control @error('tag') is-invalid @enderror mb-2" value="" />
                               <!--end::Input-->
                           </div>
                        </div>
                        <!--begin::Body-->
                                    ...
                                    <div class="form-group">
                                        <div data-repeater-list="options"
                                            ...
                                            <div data-repeater-item=""
                                                ...
                                                <!--end::Select2-->
                                                <!--begin::Input-->
                                                <input type="text"  data-kt-repeater="tagify" class="form-control mw-100 w-200px"
                                                       name="value" placeholder="القيمة" />
                                                <!--begin::Input-->
