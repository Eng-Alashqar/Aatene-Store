    ...
    <div class="card-toolbar d-flex align-items-center">
        ...
        <div class="d-flex my-0">
            ...
            <select name="status" data-control="select2" data-hide-search="true" data-placeholder="الحالة"
                ...
                <option value="active" @selected(request()->query('status') == 'active')>منتج نشط</option>
                <option value="draft" @selected(request()->query('status') == 'draft')>منتج مسودة</option>
                <option value="archived" @selected(request()->query('status') == 'archived')> منتج مؤرشف</option>
            </select>
            <!--end::Select-->
            <!--begin::Select-->
        ...
        <div class="d-flex align-items-center">
            ...
            <a href="{{ route('dashboard.products.index') }}" class="btn btn-sm btn-light-primary btn-icon fs-3 me-5"><i
